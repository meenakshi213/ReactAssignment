    ...
    <Box fill>
        <div className="App">
          <Box w="100%" h="100%" backgroundColor="hsl(172, 67%, 45%)" pb="5%">
            {/* <Text ml="35%" pt="3%" pb="2%" fontSize="24px" fontFamily ="Space Mono">
         SPLITTER
       </Text> */}
            <Image src={logo} alt="logo" ml="35%" pt="3%" pb="2%" />
            ...
            >
              <VStack spacing="10%">
                <Box w="88">
                  <Text fontFamily="Space Mono">Bill</Text>
                  <form>
                    <InputGroup>
                      <InputLeftElement>
                        <span>
                    ...
                    <Text fontFamily="Space Mono">Select Tip %</Text>
                    ...
                    <Text fontFamily="Space Mono">Number of People</Text>
                    <Input
                      style={{
                        width: "273px",
                        color: "black",
                ...
                >
                  ...
                  <HStack spacing="36%">
                    ...
                    >
                      <Image src={dollar} alt="logo" />{" "}
                      {(bill / person + (bill * tip) / 100 / person).toFixed(2)}
                    </Text>
                  </HStack>
                  <Button
                    cursor="pointer"
